...
namespace Icebox
{
	public class SimPath
	{
		...
		public void Databind(SimPathType pathType, SimBox box)
		{
		...
		public SimPoint AddPoint(SimVector3 worldPosition)
		{
			...
			point.Databind(this, nextPointId++, worldPosition);
		...
		public SimSegment AddSegment(SimSegmentType segmentType, SimPoint p1, SimPoint p2)
		{
			...
			segment.Databind(this, segmentType, nextSegmentId++, p1, p2);
